function [PSNR, y_est] = BM3D_optpara_20160404YY(y, z, sigma, profile, print_to_screen)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%%%%%%%%%
%%%%%%%%%   parameters refernce based on simulations. Li & Dr.Hou
...
Nstep               = 2;   %% sliding step to process every next reference block
N2                  = 16;  %% maximum number of similar blocks (maximum size of the 3rd dimension of a 3D array)
Ns                  = 100;  %% length of the side of the search neighborhood for full-search block-matching (BM), must be odd
tau_match           = 600;%% threshold for the block-distance (d-distance)
lambda_thr2D        = 0;   %% threshold parameter for the coarse initial denoising used in the d-distance measure
lambda_thr3D        = 2.9; %% threshold parameter for the hard-thresholding in 3D transform domain
beta                = 0.2; %% parameter of the 2D Kaiser window used in the reconstruction
