function [PSNR, y_est] = BM3D_optpara_XT20170819MoS2(y, z, sigma, profile, print_to_screen,tempVar)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
N1                  = 20;   %% N1 x N1 is the block size used for the hard-thresholding (HT) filtering
...
lambda_thr3D        = 3.4; %% threshold parameter for the hard-thresholding in 3D transform domain
