...
Recon_filename = [homeDir '3_Resire_Dose5p6e4_BM3D_After_Alignment.mat']  

ourputstring_prefix = [inputDir '3_polyn_tracing_BM3D_After_Alignment']
%% load reconstructed 3D volume
Dsetvol0 = importdata(Recon_filename);
Dsetvol0 = Dsetvol0.reconstruction;
Mask=importdata('./CoPdPt_Dose5p6e4_Mask.mat');
...
Res     = 0.333/ov;  minDist  = 2.0/Res;     SearchRad = ov;
